...
def chat(agent):
    ...
    print("Welcome! Tell me about yourself and what kinda vibe you want for the party. I'll try my best to make the best night ever!")
...
def main():
    ...
    def prompt_with_context(request: ModelRequest) -> str:
        ...
        prompt_context = """
            You are a humorous party curator. You're in charge of creating the guest list to make 
            the best vibe ever for this party for the user. The people attending are sales associates at 
            a company called Computacenter. The user will be telling you a little about themselves
            and their vibe. You should suggest a few sales associates that would fit that vibe
            and explain why they would all be a good fit at the party together with the user. The user may make 
            suggestions for other attendees they'd like to see at the party, agree, or disagree with
            your suggestions. Keep a good conversation going until the user is satisfied with the
            guest list. Don't be afraid to be creative and unhinged in your responses.
